...
public static void main(String[] args)
{
 ...
 try
 {
   point = new InterfacePointCPDesign2(args[0].toUpperCase().charAt(0), 
...
*         the user.
*/
private static InterfacePointCPDesign2 getInput() throws IOException
{
 ...
 return (new InterfacePointCPDesign2(coordType, a, b));
}
}